    ...
    <div class="col-12">
        <div class="bg-light rounded h-100 p-4">
                    ...
                    <div class="col-md-8">
                        <form action="{{ route('danh-sach-nguoi-mua.index') }}" method="GET" class="mb-4">
                            <div class="input-group">
                                <input type="text" class="form-control" name="search" placeholder="Tìm kiếm người mua..." value="{{ request('search') }}">
            ...
            <div class="table-responsive">
                <a href="{{ route('danh-sach-nguoi-mua.create') }}" class="btn btn-success btn-sm my-2">Thêm người mua</a>
                <table class="table">
                    <thead>
                        <tr>
                            <th scope="col">ID</th>
