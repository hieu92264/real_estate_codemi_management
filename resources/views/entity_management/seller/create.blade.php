...
@section('content')
    <div class="container d-flex justify-content-center align-items-center flex-column rounded p-4"
        ...
        <form action="{{ route('danh-sach-nguoi-ban.store') }}" method="POST" class="w-100">
            @csrf
            <div class="mb-3 row">
        ...
        <form action="{{ route('danh-sach-nguoi-ban.store') }}" method="POST" enctype="multipart/form-data" class="w-100">
            @csrf
            <div class="mb-3 row">
